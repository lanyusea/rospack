...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_3I.pack(_x.bb.header.seq, _x.bb.header.stamp.secs, _x.bb.header.stamp.nsecs))
      ...
      _x = self
      buff.write(_struct_4if3I.pack(_x.bb.x, _x.bb.y, _x.bb.width, _x.bb.height, _x.bb.confidence, _x.img.header.seq, _x.img.header.stamp.secs, _x.img.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.bb.header.seq, _x.bb.header.stamp.secs, _x.bb.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      ...
      (_x.bb.x, _x.bb.y, _x.bb.width, _x.bb.height, _x.bb.confidence, _x.img.header.seq, _x.img.header.stamp.secs, _x.img.header.stamp.nsecs,) = _struct_4if3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
